...
/* harmony import */ var _vendor_Draggable_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/Draggable.min */ "./src/js/vendor/Draggable.min.js");
/* harmony import */ var _vendor_Draggable_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_Draggable_min__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_InertiaPlugin_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/InertiaPlugin.min */ "./src/js/vendor/InertiaPlugin.min.js");
/* harmony import */ var _vendor_InertiaPlugin_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_InertiaPlugin_min__WEBPACK_IMPORTED_MODULE_2__);
// import $ from 'jquery'
// window.$ = $
...
!function (e, t) {
  ...
  var h,
    ...
    O = function _placeSiblings(e, t) {
      ...
      if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? g : f, s) c ? (i = -(r = function _getCTM(e) {
        ...
        if (i = a = 0, y) for (o = e.offsetParent, r = e; (r = r && r.parentNode) && r !== o && r.parentNode;) 4 < (p.getComputedStyle(r)[v] + "").length && (i = r.offsetLeft, a = r.offsetTop, r = 0);
        if ("absolute" !== (l = p.getComputedStyle(e)).position && "fixed" !== l.position) for (o = e.offsetParent; u && u !== o;) i += u.scrollLeft || 0, a += u.scrollTop || 0, u = u.parentNode;
  ...
  function Sa(r, i, e, t, a, n) {
    ...
    if (i) if (1 !== a && i instanceof Array) {
      if (c.end = o = [], s = i.length, Y(i[0])) for (l = 0; l < s; l++) o[l] = pa(i[l], a);else for (l = 0; l < s; l++) o[l] = i[l] * a;
      e += 1.1, t -= 1.1;
    ...
    function Hh(e, t) {
      ...
      if (!p || J.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && ke() - ae < 30 && De[J.pointerEvent.type]) z && e && p && za(e);else {
        ...
        if (B = !(!v || U == $ || !1 === J.vars.allowNativeTouchScrolling || J.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (U ? "y" : "x"), (z = !B && !J.allowEventDefault) && (za(e), xa(xe, "touchforcechange", za)), e.changedTouches ? (e = x = e.changedTouches[0], m = e.identifier) : e.pointerId ? m = e.pointerId : x = m = null, Ee++, function _addToRenderQueue(e) {
          ...
          scrollTo: 1
        }, !0), J.tween = J.lockedAxis = null, !u.zIndexBoost && (G || f || !1 === u.zIndexBoost) || (h.style.zIndex = Draggable.zIndex++), J.isPressed = !0, g = !(!u.onDrag && !J._listeners.drag), s = !(!u.onMove && !J._listeners.move), !1 !== u.cursor || u.activeCursor) for (n = q.length; -1 < --n;) ge.set(q[n], {
...
/***/ "./src/js/vendor/InertiaPlugin.min.js":
/*!********************************************!*\
  !*** ./src/js/vendor/InertiaPlugin.min.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports) {
...
!function (t, e) {
  ...
  function r(t) {
    var e,
      n = a;
    if (.05 <= t - i) for (i = t; n;) ((e = n.g(n.t, n.p)) !== n.v1 || .2 < t - n.t1) && (n.v2 = n.v1, n.v1 = e, n.t2 = n.t1, n.t1 = t), n = n._next;
  }
  function t() {
  ...
  var n,
    ...
    h = function () {
      ...
      return e.get = function get(t, e) {
        ...
        return n = parseFloat(e ? r.v1 : r.g(r.t, r.p)) - parseFloat(r.v2), (i = r.rCap) && (n %= i) !== n % (i / 2) && (n = n < 0 ? n + i : n - i), function _round(t) {
...
const BODY = document.body,
  ...
  toggler = document.querySelector('.theme-color-changer');
const MODE = {
  LIGHT: 'light-mode',
  DARK: 'dark-mode'
};
